...
class StateValidity():
    def __init__(self):
        ...
        self.rs = RobotState()
        self.rs.joint_state.name = ['r_shoulder_y', 'l_shoulder_y', 'l_shoulder_x', 'r_elbow_y', 'r_shoulder_x', 'l_arm_z', 'l_elbow_y', 'r_arm_z']
        # self.rs.joint_state.name = ['r_shoulder_y', 'l_shoulder_y', 'l_shoulder_x', 'r_elbow_y', 'r_shoulder_x', 'l_arm_z', 'l_elbow_y', 'r_arm_z']
    ...
    def jointStatesCB(self, msg):
        ...
        update robot state
        '''
        self.rs.joint_state.name = msg.name
        self.rs.joint_state.position = msg.position
        # self.rs.joint_state.position = [msg.position[i] for i, j in enumerate(msg.name) if j in self.rs.joint_state.name]
